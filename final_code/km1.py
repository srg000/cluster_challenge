...
class Vehicle_control(object):
    ...
    def run_step(self):
        ...
        if target_point[3] == 'D':
            if abs(target_point[0] - (self.vehicle.get_location()[0])) < 8:
                self.Path_index += 1
...
def create_path(client):
    ...
    target_path_01 = [[s_1_x + 41.4, s_1_y - 5.0, 10, 'D'], [s_1_x + 61.4, s_1_y - 5.0, 6, 'P'],
                      [s_2_x - 80, b_y, 17, 'D'], [s_2_x, b_y, 10, 'D'], [b_x - 20, b_y, 10.0, 'D'],
                      [b_x, b_y, 10.4, 'D'], [b_x + 35, b_y, 10.0, 'D'], [b_x + 110, b_y, 6, 'D'],
                      [s_3_x, s_3_y, 10, 'D'], [s_3_x + 60.0, s_3_y + 5.0, 10, 'D'],
                      [s_3_x + 80.0, s_3_y + 5.0, 5, 'P'], [s_4_x + 80.0, s_3_y + 5.0, 17, 'D']]
    target_path_02 = [[s_1_x + 45.7, s_1_y - 2.5, 10, 'D'], [s_1_x + 65.7, s_1_y - 2.5, 6, 'P'],
                      [s_2_x - 80, b_y, 17, 'D'], [s_2_x, b_y, 10, 'D'], [b_x - 20, b_y, 11.5, 'D'],
                      [b_x, b_y, 11.6, 'D'], [b_x + 35, b_y, 10.4, 'D'], [b_x + 110, b_y, 6, 'D'],
                      [s_3_x, s_3_y, 10, 'D'], [s_3_x + 64.3, s_3_y + 2.5, 10, 'D'],
                      [s_3_x + 84.3, s_3_y + 2.5, 5, 'P'], [s_4_x + 84.3, s_3_y + 2.5, 17, 'D']]
    target_path_03 = [[s_1_x + 50.0, s_1_y + 0.0, 10, 'D'], [s_1_x + 70.0, s_1_y + 0.0, 6, 'P'],
                      [s_2_x - 80, b_y, 17, 'D'], [s_2_x, b_y, 10, 'D'], [b_x - 20, b_y, 12.0, 'D'],
                      [b_x, b_y, 12.0, 'D'], [b_x + 35, b_y, 10.6, 'D'], [b_x + 110, b_y, 6, 'D'],
                      [s_3_x, s_3_y, 10, 'D'], [s_3_x + 64.3, s_3_y - 2.5, 10, 'D'],
                      [s_3_x + 84.3, s_3_y - 2.5, 5, 'P'], [s_4_x + 84.3, s_3_y - 2.5, 17, 'D']]
    target_path_04 = [[s_1_x + 45.7, s_1_y + 2.5, 10, 'D'], [s_1_x + 65.7, s_1_y + 2.5, 6, 'P'],
                      [s_2_x - 80, b_y, 17, 'D'], [s_2_x, b_y, 10, 'D'], [b_x - 20, b_y, 11.0, 'D'],
                      [b_x, b_y, 11.2, 'D'], [b_x + 35, b_y, 10.2, 'D'], [b_x + 110, b_y, 6, 'D'],
                      [s_3_x, s_3_y, 10, 'D'], [s_3_x + 60.0, s_3_y - 5.0, 10, 'D'],
                      [s_3_x + 80.0, s_3_y - 5.0, 5, 'P'], [s_4_x + 80.0, s_3_y - 5.0, 17, 'D']]
    target_path_05 = [[s_1_x + 41.4, s_1_y + 5.0, 10, 'D'], [s_1_x + 61.4, s_1_y + 5.0, 6, 'P'],
                      [s_2_x - 80, b_y, 17, 'D'], [s_2_x, b_y, 10, 'D'], [b_x - 20, b_y, 10.5, 'D'],
                      [b_x, b_y, 10.8, 'D'], [b_x + 35, b_y, 10.1, 'D'], [b_x + 110, b_y, 6, 'D'],
                      [s_3_x, s_3_y, 10, 'D'], [s_3_x + 60.0, s_3_y + 0.0, 10, 'D'],
                      [s_3_x + 80.0, s_3_y + 0.0, 5, 'P'], [s_4_x + 80.0, s_3_y + 0.0, 17, 'D']]
...
def main():
    ...
    try:
        ...
        node_y_list = [[nodes[0].get_location()[1], 0], [nodes[1].get_location()[1], 1],
                       [nodes[2].get_location()[1], 2], [nodes[3].get_location()[1], 3],
                       [nodes[4].get_location()[1], 4]]
        node_y_list = sorted(node_y_list, key=lambda x: x[0])
        print(node_y_list)
        target_paths = create_path(client)

        # 车辆控制a
        control_object_01 = Vehicle_control(nodes[node_y_list[0][1]], target_paths[0])
        control_object_02 = Vehicle_control(nodes[node_y_list[1][1]], target_paths[1])
        control_object_03 = Vehicle_control(nodes[node_y_list[2][1]], target_paths[2])
        control_object_04 = Vehicle_control(nodes[node_y_list[3][1]], target_paths[3])
        control_object_05 = Vehicle_control(nodes[node_y_list[4][1]], target_paths[4])
        ...
        def all_control():
            ...
            while True:
                ...
                if sum(target_mission) == 5 and count == 0:
                    ...
                    lock.acquire()
                    target_mission[node_y_list[2][1]] = 0
                    lock.release()
                    time.sleep(1.5)
                    lock.acquire()
                    target_mission[node_y_list[1][1]] = 0
                    lock.release()
                    time.sleep(1.5)
                    lock.acquire()
                    target_mission[node_y_list[3][1]] = 0
                    lock.release()
                    time.sleep(1.5)
                    lock.acquire()
                    target_mission[node_y_list[0][1]] = 0
                    lock.release()
                    time.sleep(2.5)
                    lock.acquire()
                    target_mission[node_y_list[4][1]] = 0
                    lock.release()
